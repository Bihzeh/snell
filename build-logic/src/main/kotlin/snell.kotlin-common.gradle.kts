// Shared Kotlin/JVM conventions for every Snell JVM module.
// Applied via `plugins { id("snell.kotlin-common") }`.
//
...
group = providers.gradleProperty("snell.group").getOrElse("gg.snell")
version = providers.gradleProperty("snell.version").getOrElse("0.0.1-SNAPSHOT")
